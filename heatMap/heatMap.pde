//Code by Team 11: EyeHear
//This code creates a heatmap with the data received by the devices
...
void setup() {
  ...
  xValues = new FloatList();
  yValues = new FloatList();
...
void draw() {
  ...
  xValue = 4 * float(xValueString);
  yValue = 4 * float(yValueString);
  ...
  if (xValueString != " " && yValueString != " ") {
    ...
    resetEmail();
    fill(0, 0, 255);
    circle(340 + (float)xValue, 470 - (float)yValue, 10);
    PImage screenshot=  get(200, 0, 600, 600);
    screenshot.save("C:/Users/andre/OneDrive/Desktop/heatMap/emailpic.jpg");
    ...
    screenshot.save("C:/Users/andre/OneDrive/Desktop/heatMap/livepicture.jpg");
    screenshot.save("C:/Users/andre/OneDrive/Desktop/heatMap/historicPicture_" + count + ".jpg");
